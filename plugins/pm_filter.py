...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⚡ How To Download ⚡", url=f"https://t.me/Team_HDR/5")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton(
                '🏆 Group 🏆', url='https://t.me/RequestGroupTamil'),
            InlineKeyboardButton(
                '📣 Updates 📣', url='https://t.me/DeltaFiles')
        ], [
            InlineKeyboardButton('📚 Hᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('Aʙᴏᴜᴛ 🌐', callback_data='about')
        ], [
            InlineKeyboardButton('🔗 Subscribe Anime Channel 🔗',
                                 url=f'https://t.me/Crunchyroll_Tamil_Official')
        ]] 
